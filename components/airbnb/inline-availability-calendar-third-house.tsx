...
export function InlineAvailabilityCalendarThirdHouse() {
  const { t, language } = useLanguage()
  const { setBookingDates } = useBookingThirdHouse()
  ...
  const { titleText, rangeText, nights } = useMemo(() => {
    ...
    return {
      titleText: `${nightsCount} ${nightsCount > 1 ? t("booking.nights") : t("booking.night")} in İzmir`,
