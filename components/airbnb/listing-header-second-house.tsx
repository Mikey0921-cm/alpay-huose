...
export function ListingHeaderSecondHouse() {
          ...
          >
            ...
            <div className="mb-6 flex items-center gap-4 rounded-lg border border-border p-4">
              <div className="h-16 w-16 flex-shrink-0 overflow-hidden rounded-lg bg-secondary">
                <img src="https://a0.muscache.com/im/pictures/5d1d2b29-94e9-4d21-ad6d-7aa256979bf9.jpg?im_w=240" alt="Listing" className="h-full w-full object-cover" />
              </div>
              <div>
                <p className="text-sm font-medium text-foreground">Garden Escape - Foça</p>
