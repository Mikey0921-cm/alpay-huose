...
import { useBookingThirdHouse } from "@/components/airbnb/booking-context-third-house"
...
export function BookingCardThirdHouse() {
  const { t, language } = useLanguage()
  const { currency } = useCurrency()
  const { checkIn, checkOut, nights, totalUsd, totalTry, setBookingDates } = useBookingThirdHouse()
            ...
            {guestsOpen && (
              <div className="absolute left-0 right-0 top-full z-10 rounded-b-xl border border-t-0 border-border bg-background p-4 shadow-lg">
                {[
                  ...
                  { label: t("booking.children"), desc: t("booking.ages2to12"), value: 0, min: 0, max: 2, key: "children" },
