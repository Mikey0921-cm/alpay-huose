          ...
          >
            ...
            <div className="mb-6 flex items-center gap-4 rounded-lg border border-border p-4">
              <div className="h-16 w-16 flex-shrink-0 overflow-hidden rounded-lg bg-secondary">
                <img src="/images/listing-main.jpg" alt="Listing" className="h-full w-full object-cover" />
              </div>
              <div>
                <p className="text-sm font-medium text-foreground">Olive Grove Retreat - Fo{"\\u00e7"}a</p>
